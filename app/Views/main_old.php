...
<style>
    ...
    /* Slight separation between outcome rows */
    #outcomeTable tbody tr:not(.grade-divider) td {
        border-bottom: 1px solid #f1f3f5;
    }

    /* Slightly more comfortable hover */
    #outcomeTable tbody tr:not(.grade-divider):hover {
