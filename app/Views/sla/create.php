...
<div class="card shadow-sm border-0">
    ...
    <div class="card-header bg-white py-3 d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3">
        ...
        <h5 class="mb-0 text-primary fw-bold">
            ...
            Create Student Late Arrival Slip
        </h5>
    ...
    <div class="card-body p-3 p-sm-4">
        ...
        <!-- FORM -->
        <form action="<?= base_url('sla/store') ?>"
              method="post">
            ...
            <div class="mb-4">
                ...
                <textarea name="reason"
                          ...
                          required><?= esc(old('reason')) ?></textarea>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Student selected before validation error
    const oldStudentId = <?= json_encode(old('student_id', '')) ?>;


    /**
     * Load students based on class and division
     */
    function loadStudents(classId, selectedStudentId = '') {
        ...
        const url =
            ...
            + '?division='
            + encodeURIComponent('<?= $division_id ?>');
    ...
    classSelect.addEventListener(
        ...
        function () {
            ...
            // New class = clear student selection
            loadStudents(
                this.value,
                ''
            );
