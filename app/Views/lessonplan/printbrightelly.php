...
<head>
    ...
    <style>
        ...
        /* ============================================= */
        /* Header Profesional (Kop Surat Sekolah)         */
        /* ============================================= */
        .letterhead {
            display: flex;
            align-items: center;
        ...
        /* Ganti halaman baru sebelum Bagian C */
        .section-break {
        ...
        /* ============================================= */
        /* Watermark - fixed, tampil di TIAP halaman cetak */
        /* ============================================= */
        .watermark {
            position: fixed;
            top: 50%;
        ...
        /* Watermark harus tetap position:fixed (bukan relative) walau di dalam .document-container,
           dan harus di bawah konten (z-index lebih rendah) */
...
<div class="document-container">
    <!-- Watermark: position:fixed sehingga berulang di tengah setiap halaman saat print.
         Diletakkan sebagai anak pertama di sini (bukan sibling) supaya tetap tampil
         di ATAS background putih halaman, tapi di BAWAH konten. -->
    ...
    <!-- Kop Surat / Letterhead Profesional -->
    <div class="letterhead">
        <img class="letterhead-logo" src="<?= base_url('logobrightelly.png') ?>" alt="Logo Sekolah">
...
') ?></p>
        ...
        <img class="letterhead-logo" src="<?= base_url('logobrightelly.png') ?>" alt="Logo Sekolah" style="visibility:hidden;">
    </div>
...
<tr>
    ...
    <td>
        <?= esc($lessonplan['agama1_name'] ?? $lessonplan['agama1'] ?? 'Belum dipilih') ?>
        <?php if (!empty($lessonplan['agama2'])): ?>
            <br>
...
<tr>
    ...
    <td>
        <?= esc($lessonplan['jati1_name'] ?? $lessonplan['jati1'] ?? 'Belum dipilih') ?>
        <?php if (!empty($lessonplan['jati2'])): ?>
            <br>
...
<tr>
    ...
    <td>
        <?= esc($lessonplan['dasar1_name'] ?? $lessonplan['dasar1'] ?? 'Belum dipilih') ?>
        <?php if (!empty($lessonplan['dasar2'])): ?>
            <br>
    ...
    <!-- Bagian 3: Pelaksanaan & Media (Halaman baru) -->
    <h3 class="section-break">C. Rincian Pelaksanaan</h3>
    <table class="data-table">
        <tr>
...
<div class="document-container">
    ...
    <div class="letterhead">
        <img class="letterhead-logo" src="<?= base_url('logobrightelly.png') ?>" alt="Logo Sekolah">
        <div class="letterhead-text">
            <h1><?= esc($lessonplan['school_name'] ?? 'Nama Sekolah') ?></h1>
            <p><?= esc($lessonplan['school_address'] ?? 'Alamat Sekolah, Kota, Provinsi') ?></p>
            <p><?= esc($lessonplan['school_contact'] ?? 'Telp: - | Email: -') ?></p>
        </div>
        <img class="letterhead-logo" src="<?= base_url('logobrightelly.png') ?>" alt="Logo Sekolah" style="visibility:hidden;">
    </div>
