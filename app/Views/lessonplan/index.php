...
<div class="glass-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h5 class="mb-0">Manajemen Lesson Plan</h5>
            <small class="text-white-50">
                Total Data: <?= isset($lessonplans) ? count($lessonplans) : 0 ?>
            </small>
        </div>

        <a href="<?= base_url('lessonplan/create'); echo "?subject_id=".$_GET['subject_id'] ?> "
           class="btn btn-primary rounded-pill px-3">
            <i class="bi bi-plus-lg me-1"></i> Tambah Lesson Plan
        </a>
    </div>
    ...
    <?php if (empty($lessonplans)): ?>
        <div class="text-center py-5">
            ...
            <p class="mt-3 text-muted">Belum ada data lesson plan.</p>
        </div>
    <?php else: ?>
